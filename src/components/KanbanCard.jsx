...
const KanbanCard = (props) => {
  ...
  return (
         <div key={'div-' + props.cardIndex} onDragOver={(event) => event.preventDefault()} onDrop={(event) => props.onTaskDrop(event, props.cardIndex)} style={{ maxWidth: '25%', marginTop: 10, marginLeft: 10 }}>
